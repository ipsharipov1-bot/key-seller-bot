...
# URL Mini App (замените после деплоя на GitHub Pages)
# MINI_APP_URL = "https://ipsharipov1-bot.github.io/key-seller-bot/"
# Или используйте конструктор Telegram:
# MINI_APP_URL = "https://t.me/Vanesspay_bot/app"  # после настройки через BotFather
...
def get_main_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("📱 О нас | Отзывы | FAQ | Гарантии", callback_data="open_app")],
    ]
